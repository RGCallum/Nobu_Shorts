...
const film3 = new Film({
    ...
    synopsis: "A documentation of the creative process of Simone Leigh, a Brooklyn based sculptor and video artist.",
    role: "Director",
    type: "Documentary",
    year: 2012,
    location: "Brooklyn NY",
...
const film4 = new Film({
    ...
    synopsis: "An electrifying portrait of a young artist determined to live life on his own terms.",
    role: "Director",
    type: "Documentary",
    year: 2013,
    location: "Brooklyn NY",
