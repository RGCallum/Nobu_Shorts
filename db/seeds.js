...
const film7 = new Film({
    ...
    tagline: "A Nigerian-American bride makes a plan to confront her mother to gain autonomy over her wedding day, but is derailed by a secret that could forever change the course of her family's future.",
...
const film9 = new Film({
    ...
    tagline: "A compelling look into the life of African American Inventor Granville T. Woos",
    role: "Narrator",
    type: "Documentary",
    year: 2010,
    location: "Brooklyn NY",
...
const film10 = new Film({
    ...
    tagline: "A quick look at one of the original IRT stations' architecture (Bleeker Street) dating back to 1904 boasting classic mosaics and terra cotta finishes as well as some other restored and renovated stations.",
